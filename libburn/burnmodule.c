...
/* End of code for toc_entry objects */
/* -------------------------------------------------------- */
...
static char b_source_define_data__doc__[] = 
""
;

static PyObject *
b_source_define_data(b_sourceobject *self, PyObject *args)
{
	if (!PyArg_ParseTuple(args, ""))
		return NULL;
	Py_INCREF(Py_None);
...
static char b_source_set_isrc__doc__[] = 
""
;

static PyObject *
b_source_set_isrc(b_sourceobject *self, PyObject *args)
{
	if (!PyArg_ParseTuple(args, ""))
		return NULL;
	Py_INCREF(Py_None);
...
static char b_source_clear_isrc__doc__[] = 
""
;

static PyObject *
b_source_clear_isrc(b_sourceobject *self, PyObject *args)
{
	if (!PyArg_ParseTuple(args, ""))
		return NULL;
	Py_INCREF(Py_None);
...
static struct PyMethodDef b_source_methods[] = {
 ...
 {"define_data",	(PyCFunction)b_source_define_data,	METH_VARARGS,	b_source_define_data__doc__},
 {"set_isrc",	(PyCFunction)b_source_set_isrc,	METH_VARARGS,	b_source_set_isrc__doc__},
 {"clear_isrc",	(PyCFunction)b_source_clear_isrc,	METH_VARARGS,	b_source_clear_isrc__doc__},
...
/* End of code for source objects */
/* -------------------------------------------------------- */
...
/* End of code for drive_info objects */
/* -------------------------------------------------------- */
...
static PyObject *
b_drive_disc_get_status(b_driveobject *self, PyObject *args)
{
	if (!PyArg_ParseTuple(args, ""))
		return NULL;
	Py_INCREF(Py_None);
...
static char b_drive_erasable__doc__[] = 
""
;

static PyObject *
b_drive_erasable(b_driveobject *self, PyObject *args)
{
	if (!PyArg_ParseTuple(args, ""))
		return NULL;
	Py_INCREF(Py_None);
...
static char b_drive_get_status__doc__[] = 
""
;
...
static char b_drive_disc_erase__doc__[] = 
""
;

static PyObject *
b_drive_disc_erase(b_driveobject *self, PyObject *args)
{
	if (!PyArg_ParseTuple(args, ""))
		return NULL;
	Py_INCREF(Py_None);
...
static char b_drive_disc_read__doc__[] = 
""
;

static PyObject *
b_drive_disc_read(b_driveobject *self, PyObject *args)
{
	if (!PyArg_ParseTuple(args, ""))
		return NULL;
	Py_INCREF(Py_None);
...
static char b_drive_drive_cancel__doc__[] = 
""
;

static PyObject *
b_drive_drive_cancel(b_driveobject *self, PyObject *args)
{
	if (!PyArg_ParseTuple(args, ""))
		return NULL;
	Py_INCREF(Py_None);
...
static struct PyMethodDef b_drive_methods[] = {
 ...
 {"disc_get_status",	(PyCFunction)b_drive_disc_get_status,	METH_VARARGS,	b_drive_disc_get_status__doc__},
 {"erasable",	(PyCFunction)b_drive_erasable,	METH_VARARGS,	b_drive_erasable__doc__},
 {"get_status",	(PyCFunction)b_drive_get_status,	METH_VARARGS,	b_drive_get_status__doc__},
 {"disc_erase",	(PyCFunction)b_drive_disc_erase,	METH_VARARGS,	b_drive_disc_erase__doc__},
 {"disc_read",	(PyCFunction)b_drive_disc_read,	METH_VARARGS,	b_drive_disc_read__doc__},
 {"drive_cancel",	(PyCFunction)b_drive_drive_cancel,	METH_VARARGS,	b_drive_drive_cancel__doc__},
...
/* End of code for progress objects */
/* -------------------------------------------------------- */
...
static char b_write_opts_set_has_mediacatalogset_mediacatalaog__doc__[] = 
""
;

static PyObject *
b_write_opts_set_has_mediacatalogset_mediacatalaog(b_write_optsobject *self, PyObject *args)
{
	if (!PyArg_ParseTuple(args, ""))
		return NULL;
	Py_INCREF(Py_None);
...
static struct PyMethodDef b_write_opts_methods[] = {
 ...
 {"set_has_mediacatalogset_mediacatalaog",	(PyCFunction)b_write_opts_set_has_mediacatalogset_mediacatalaog,	METH_VARARGS,	b_write_opts_set_has_mediacatalogset_mediacatalaog__doc__},
...
/* End of code for write_options objects */
/* -------------------------------------------------------- */
...
/* End of code for read_options objects */
/* -------------------------------------------------------- */
...
/* End of code for session objects */
/* -------------------------------------------------------- */
