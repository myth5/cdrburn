...
int burn_drive_equals_adr(struct burn_drive *d1, char *adr2_in, int role2)
{
    ...
    */
    ...
    if (role1 == 1 && role2 == 1) {
        ...
        if (conv_ret2 <= 0)
        {
            ret = 0;    /* no MMC drive at adr2 */
            goto ex;
        }
        if (strcmp(adr1, conv_adr2) == 0)
        {
            ret = 1;    /* equal real MMC drives */
            goto ex;
        }
        {
            ret = 0;
    ...
    } else if (role1 == 0 || role2 == 0)
    {
        ...
        {
            ret = 1;    /* same major,minor device number */
            goto ex;
        }
        ...
        {
            ret = 0;    /* no MMC drive at adr1 */
            goto ex;
        }
        if (strcmp(conv_adr1, conv_adr2) == 0)
        {
            ret = 1;    /* same MMC drive */
            goto ex;
        }

        {
            ret = 0;    /* all filesystem disguises are checked */
            goto ex;
        }
